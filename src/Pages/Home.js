        ...
        <div className='row d-flex justify-content-center '>
            <div className='col-lg-8'>
                ...
                <p className='text-center'>Search through our listing of real estate properties in Nepal and contact owner / agency directly to make a deal.</p>
                 <div className='d-flex gap-3'>
                  ...
                  <Link to={`/cat/${x.cat}`}><img width="50" src='https://www.gharghaderi.com/icon/house.png'/></Link>
                    ...
                    <Link className='link-dark' to={`/cat/${x.cat}`}><p className='px-3 '>House for sale</p></Link>
                        </div>
                        </>
                        ))}
                    </div>
                    ...
                    <Link to={`/cat/${x.cat}`}><img width="50" src='https://www.gharghaderi.com/icon/land.png'/></Link>
                        <div className='d-flex flex-column justify-content-center '>
                        <Link className='link-dark' to={`/cat/${x.cat}`}>  <p className='px-3'>Land for sale </p></Link>  
                        </div>
                        </>
                        ))}
                    </div>
                  ...
                  <Link to={`/cat/${x.cat}`}><img width="50" src='https://www.gharghaderi.com/icon/rent.png'/></Link>
                        <div className=' d-flex flex-column justify-content-center'>
                <Link className='link-dark' to={`/cat/${x.cat}`}><p className='px-3'>For Rent</p></Link> 
                        </div>
                        </>
                        ))}
                    </div>
                ...
                <Link to={`/cat/${x.cat}`}><img width="50" src='https://www.gharghaderi.com/icon/blog.png'/></Link>
                        <div className='d-flex flex-column justify-content-center'>
                     <Link className='link-dark' to={`/cat/${x.cat}`}><p className='px-3'>News|Blogs</p></Link>
                        </div>
                        </>
                        ))}
                    </div>
                 ...
                 <div className='py-5 d-flex mx-5'>
                    <div className='mx-5 '>
                    <p><i class="bi bi-whatsapp fs-1 "></i></p>
                    <p className='lh-1'>9849124654</p>
                    </div>
                    <div className='mx-5'>
                    <p><i class="bi bi-instagram fs-1"></i></p>
                    <p className='lh-1'>contact us</p>
                    </div>
                    <div className='mx-5'>
                    <p><i class="bi bi-twitter fs-1"></i></p>
                    <p className='lh-1'>Tweet us</p>
                    </div>
                    <div className='mx-5'>
                    <p><i class="bi bi-hourglass-top fs-1"></i></p>
                    <p className='lh-1'>availabilty 24/7</p>
                    </div>
                    </div>
...
<section>
  ...
  <h2>Agencies<span><button className='mx-2 btn bg-danger text-white'>see all</button></span></h2>
    ...
    <div className="card zoom" style={{width: '15rem'}}>
